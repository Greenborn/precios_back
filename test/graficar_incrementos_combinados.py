...
DEFAULT_SVG = os.path.join(DEFAULT_OUTDIR, 'incrementos_combinados.svg')
...
plt.title('Media diaria y acumulada de incrementos interdiarios', fontsize=16, fontweight='bold')
...
print(f'Gráfico combinado guardado: {svg_path}') 